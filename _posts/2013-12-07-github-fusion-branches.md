...
Une fois que vous avez produit  une nouvelle branche et fini le travail sur votre dernière idée, vous voudrez fusionner les modifications dans `master` (ou peut-être une autre branche), de manière à ce qu'elles fassent partie du principal corps de travail.

Si vous travaillez comme membre d'une équipe, c'est une bonne pratique d'avoir une révision de votre branche par vos collègues (peut-être en produisant une pull request sur GitHub.com) avant de la fusionner.

Pour fusionner une branche dans GitHub pour Mac :

1. Cliquez sur le bouton "Merge View" sur l'onglet Branches.
2. Cliquez et faites glissez le handle de la branche dont vous voulez fusionner les modifications (votre nouvelle branche), et déposez-le dans la boîte de gauche. Le handle à glisser peut être trouvé sur le côté gauche de la ligne de la branche.
...
![image](https://github-images.s3.amazonaws.com/mac/changes/merging-20130109-131344.jpg "Fusion de Branche dans GitHub pour Mac")
