---
layout: post
title:  Démarrer des Collections dans Jekyll 2.xx
description: "Un post qui peut aider si vous coincez sur le fonctionnement des collections dans Jekyll"
redirect_from:
  - /2014-365/
  - /2014-365/collections-jekyll
...
La première tâche prioritaire début 2015 s’articulera probablement autour du façonnage technique du conteneur. Conforté –pour cette exploration à venir– de bosser sur Jekyll qui brille par sa simplicité et la force de sa communauté. 
En outre, les versions récentes de Jekyll 2.x intègrent désormais une nouvelle fonctionnalité intéressante pour publier des **Collections**. 

Dans cet article je vous donnerai un aperçu des raisons pour lesquelles je compte poursuivre l’apprentissage indieweb sur Jekyll en 2015, comment vous pouvez aussi vous y mettre rapidement et conclurai par quelques astuces sur les collections Jekyll. Astuces intégralement inspirées de l'excellent post de [Taylor Jones](http://www.sitepoint.com/getting-started-jekyll-collections/). 
...
Pour l’année 2015, mes motivations sont purement égoïstes : j’ai réellement besoin de professionnaliser un premier portfolio de présentation et ramener quelques amis pour aider à construire un IndieWebCamp francophone. Telle est la raison pour laquelle, je reste focalisé sur une motorisation simple, flexible et facilement personnalisable pour publier quelques pages, articles et petites notes de statut. 
...
Ces prérequis étant posés, vous n'êtes plus qu'à 4 lignes à saisir dans le terminal pour faire tourner votre premier site web Jekyll. 
...
### Pour conclure avant 2015 

Jekyll est une motorisation pratique pour construire de petits sites statiques. Cela vaut la peine de l'envisager pour tous les   sites web ayant besoin d'un backend robuste - pouvant aussi intégrer de la manipulation de data et de la recherche. Un point à garder en tête pour votre prochain projet. 
